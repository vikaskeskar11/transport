						...
						<div class="tab-content">
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-md-4">
									<input required type="Text"  name="companyid" id="regid1"  class="form-control">
									<br><br>
									</div>	
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<input  type="text" placeholder="RTO Tax Amt." name="tax1" id="rtoamt" class="form-control">
									<br><br>
									</div>	
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<input type="date"  name="tax" id="rtodate" class="form-control">
									<br><br>
									</div>	
								</div>
								...
								<div class="form-group">
								<button type="submit" name= "form_submit" class="btn btn-primary" style="width:100px;">Modify</button>
