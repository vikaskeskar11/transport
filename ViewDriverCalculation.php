...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" >			
		...
		<div class="row" >
			<div class="col-lg-12">
			<h2 class="page-header" style="color:#1F618D  ;">View Driver Calculation</h2>
			</div>
			
			<div class="form-group" align="center">
									<label class="col-md-2 control-label" for="name">Select </label>
									<div class="col-md-10">
			...
			<div class="col-lg-12" >
					...
					<div class="form-group" align="center">
									...
									<div class="col-md-2">
									<input  id="sad"  name="ad"  type="number" placeholder="From"  class="form-control">
									</div>
									
									<label class="col-md-1 control-label" for="name">To </label>
									<div class="col-md-1">
									<input  id="rate"  name="ad"  type="number" placeholder="To"  class="form-control">
									</div>
