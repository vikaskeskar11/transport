...
<![endif]-->
	...
	if(extract($_POST))
	{
		...
		extract($_POST);
		$query = "UPDATE  disel  SET  did ='$did', dslip ='$dslip', slipdate ='$slipdate', dvehicle ='$dvehicle', ddriver ='$ddriver', dpump ='$dpump', dform ='$dfrom', dto ='$dto', dqunity_ordered ='$dqunity_ordered', dqunity_actual ='$dqunity_actual', dstart_reading ='$dstart_reading', dend_reading ='$dend_reading', dtotal_km ='$dtotal_km', davg ='$davg', drate ='$drate', damount ='$damount', dremark ='$dremark	' WHERE dslip='$slipno'";
		$result = mysqli_query($conn,$query) or die(mysqli_error($conn));
		if($result)
		{
			echo"<script type=\"text/javascript\">".
            "alert(' Diesel Usages Modified Successfully');".
            "</script>";
		}else
		{
			echo"<script type=\"text/javascript\">".
            "alert('Error in Modifying Diesel Usage.Please Try again.');".
            "</script>";
		}
...
<form action="ModifyDiselUsages.php" method="post">
							...
							<div class="col-lg-12">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										...
										{
									echo '<input  list="vehicle_list" id="dvehicle"  name="dvehicle"  type="text" placeholder="vehicle"  class="form-control">';
									echo '<datalist id="vehicle_list">';
...
<script id="source" language="javascript" type="text/javascript">
  ...
  var name=document.getElementById("slipno").value;
	...
	$.ajax({                                      
	  ...
	  document.getElementById('dvehicle').value=data[3];
